...
var lw = 0;
function tick() {
    if (lh != screen.availHeight || lw != screen.availWidth) {
        if (screen.availHeight < screen.availWidth) {
            ...
            document.getElementById("hometable").innerHTML = '<tbody><tr><td><a class="divimagelink" href="./Green/index.html"><div id="green"><strong>The Ways We\'re Green</strong></div></a></td></tr><tr><td><a class="divimagelink" href="./Homes/index.html"><div id="homes"><strong>Find Homes</strong></div></a></td></tr><tr><td><a class="divimagelink" href="./About/index.html"><div id="about"><strong>Learn More About Us</strong></div></a></td></tr></tbody>';
        }
        lh = screen.availHeight;
        lw = screen.availWidth;
    }
}
function start() {
